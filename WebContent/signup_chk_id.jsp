...
<html>
	...
	<body>
		...
		<section id ="section_id">
				<article>
					<form action="signup_chk_id_db.jsp" method="post">		
						<div>
						<table align="center">
						<tr>
						...
						<tr>
							<td colspan="3"><input type="text" class="filed2" name="name" maxlength="10" placeholder="최대10자리"></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="3"><p><input type="button" class="submit" value="찾기" onclick="id_chk(this.form)"></p></td>
						</tr>
						</table>
						</div>
					</form>										
