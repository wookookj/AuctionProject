...
<html>
	...
	<body>
		...
		<% 
			...
			String pw_chk = (String)request.getAttribute("pw_chk");
		%>
				<article>	
						<div>
							<table align="center">
							<tr>
								<td colspan="3" class="signup_text"><font><%= id_chk %>님의 비밀번호</font></td>
							</tr>
							<tr>
								<td colspan="3"><input type="text" class="filed2" name="id" maxlength="10" placeholder="최대10자리" readonly = true; value="<%= pw_chk%>"></td>
							</tr>
							<tr>
