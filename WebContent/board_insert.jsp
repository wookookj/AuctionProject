...
%>
	...
	<body>
		...
		<section id ="section_id">
			<div><h1>커뮤니티</h1></div>
			<article>
				<form action="board_insert_db.jsp" method="post">
					<br><br><br><br>
					<div>
						<table border="0" cellspacing="0">
							...
							<tr>
								<td>내용</td>
								<td><textarea name = "main" cols="30" rows ="25"></textarea></td>
							</tr>
							<tr>
								<td>작성자</td>
					...
					<div> <br>
						<input type="button" value = "목록" onclick = "history.back()" class = "button">&nbsp;&nbsp;
