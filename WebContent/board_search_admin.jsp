...
<html>
	...
	<body>
		...
		<section id ="section_id">
			<div><h1>커뮤니티 > 공지사항</h1></div>
			<form action = "board_search_db_admin.jsp" method = "post">
			<article>
				<div>
				<br><br><br><br><div class ="free">
					...
					%>	
						<div>
							...
							<input type="text" name="search_admin" maxlength="10" value = "<%= search%>" class="search"/>
					...
					<%
						ArrayList<Board_DTO> arr = (ArrayList)request.getAttribute("arr");  
						for(int i = 0; i < arr.size(); i ++) {
							out.println("<tr>");
							out.println("<td bgcolor='#FFFFE4'>" + "<a href ='board_click.jsp?num=" + arr.get(i).getNum() + "'>" + arr.get(i).getNum() + "</a></td>");
							if(arr.get(i).getDate().length() == 5) {
								out.println("<td bgcolor='#FFFFE4'>" + "<a href ='board_click.jsp?num=" + arr.get(i).getNum() + "'>" + arr.get(i).getTitle() + "</a>&nbsp;<img src = 'image/new.png'></td>");		
							}
							else {
								out.println("<td bgcolor='#FFFFE4'>" + "<a href ='board_click.jsp?num=" + arr.get(i).getNum() + "'>" + arr.get(i).getTitle() + "</a></td>");
							}	
							out.println("<td bgcolor='#FFFFE4'>"+ arr.get(i).getDate() + "</td>");
							out.println("<td bgcolor='#FFFFE4'>"+ arr.get(i).getHits() + "</td>");
							out.println("</tr>");
						}		
					%>
					</table>
