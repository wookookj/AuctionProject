...
<html>
	...
	<script>
		function delete_page(form) {
			location.href = "delete_mypage_db.jsp?id=" + "<%=id%>";
		}
	...
	<form>
		...
		<section id ="section_id">
			<div><h1>마이페이지 > 회원탈퇴</h1></div>
			<form>
				<article>
					<div>
						<h1>정말로 탈퇴 하시겠습니까?</h1> <br><font>※ 한번 탈퇴된 정보는 복구가 불가능합니다</font><br><br>
						<input type="button" class="submit" value="탈퇴하기" onclick="delete_page(this.form)">&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="button" class="submit" value="뒤로가기" onclick="history.back()">
					</div>
				</article>
			</form>
		</section>
