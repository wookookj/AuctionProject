		...
		<section id ="section_id">
				<article>
					<form action="login_result.jsp" method="get">
						...
						<table align="center">
							<tr>
								<td colspan="3"><input type="text" class="filed" name="id" maxlength="10" placeholder="아이디" /></td>
							</tr>
							<tr>
								<td colspan="3"><input type="password" class="filed" name="pw" maxlength="15" placeholder="비밀번호" /></td>
							</tr>
							<tr>
								<td colspan="3"><input type="submit" class="submit" value="로그인"></td>
							</tr>
							<tr>
								<td class="text_smallsize"><a href="signup_chk_id.jsp">아이디 찾기</a></td>
								<td class="text_smallsize"><a href="signup_chk_pw.jsp">비밀번호 찾기</a></td>
								<td class="text_smallsize"><a href="signup_chk.jsp">회원가입</a></td>
							</tr>
						</table>
						</div>
					</form>										
