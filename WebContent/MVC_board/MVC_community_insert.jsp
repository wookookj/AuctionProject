...
%>
	...
	<body>
		...
		<section id ="section_id">
			<div><h1>커뮤니티</h1></div>
			<article>
				<form action="boardWritePro.bo" enctype="multipart/form-data" method="post">
				<input type="hidden" name="id" value="<%=id %>">
					...
					<div>
						<table border="0" cellspacing="0">
							<tr>
								<td>제목</td>
								<td><input type = "text" name = "title" maxlength = 30 placeholder = "최대30자리"></td>
							</tr>
							<tr>
								<td>내용</td>
								<td><textarea name = "content" cols="30" rows ="100"></textarea></td>
							</tr>
							<tr>
								<td>파일</td>
					...
					<div> <br>
						<input type="button" value = "목록" onclick = "history.go(-1)" class = "button">&nbsp;&nbsp;
						<input type="button" value = "작성하기" onclick = "board_insert(this.form)" class = "button">
					</div>
				</form>
			</article>
		</section>
