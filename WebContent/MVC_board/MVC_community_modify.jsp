...
%>
	<head>
		...
		<style>
			...
			table tr:nth-child(4) > td:last-child > a{
				color : black;
			}
			table tr > td:last-child {
				width : 650px;
	...
	<body>
		...
		<section id ="section_id">
			...
			<article>
			<br><br><br><br>
		<form action = "boardModifyPro.bo" enctype="multipart/form-data" method = "post">
			<div>
				...
				<table border = "0" cellspacing = "0">
					...
					<tr>
						<td>내용</td>
						<td><textarea name = "main"><%= dto.getBOARD_CONTENT() %></textarea></td>
					</tr>
					<tr>
						<td>파일</td>
			...
			<div> <br>
				...
				&nbsp;&nbsp;<input type="button" value = "초기화" onclick = "board_reset(this.form)" class = "button">			
