...
%>
	...
	<body>
		...
		<section id ="section_id">
			<div><h1>커뮤니티</h1></div>
			<article>
				<form action="boardReplyPro.bo" enctype="multipart/form-data" method="post">
					<br><br><br><br>
					...
					<div> <br>
						<input type="button" value = "뒤로" onclick = "history.go(-1)" class = "button">&nbsp;&nbsp;
						<input type="button" value = "답글" onclick = "board_insert(this.form)" class = "button">
					</div>
				</form>
			</article>
		</section>
