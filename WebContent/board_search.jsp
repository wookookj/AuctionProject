...
<html>
	...
	function array_change(form) {
		if(form.array.value == "조회수↑") {
			...
			location.href="community_freeboard.jsp";
		}
	}
		$(function (){
			$(".navbox").hide();
				...
				<br><br><br><br><div class ="free">
					...
					%>	
						...
						<div>
							...
							<input type="text" name="search" maxlength="10" value = "<%= search%>" class="search"/>
					...
					<div> <input type = button value = "작성" onclick = "location.href='board_insert.jsp'" class = "button"/> </div>			
				</article>
			</form>
		</section>
