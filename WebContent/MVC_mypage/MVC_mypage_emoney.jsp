...
<html>
	...
	<body>
	<form action = "mypage_emoney_update.jung" method="post">
		<header id="header_id">
		...
		<section id ="section_id">
			<div><h1>마이페이지 > 이머니 충전</h1></div>
			<article>
				<div>
					<div><b>충전할 금액</b></div>
					<div><input type = "text" class = "emoney" name = "emoney" maxlength = "9" onchange = "checkNumber()"></div>
					<div><input type = "button" class ="button" value = "뒤로" onclick = "history.go(-1);">&nbsp;&nbsp;<input type ="button" class ="button" value="충전" onclick="update(this.form)"></div>
				</div>
