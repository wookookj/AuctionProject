		   ...
		   if(numPattern != null){
			...
			function signup(form) {
				...
				for(int i =0; i < arr.size(); i ++) {%>
					if("<%= arr.get(i).getSign_tell()%>" == ("0"+form.tel1.value+form.tel2.value+form.tel3.value)) {
						var tell_chk = true;
					}
					else if("<%= arr.get(i).getSign_email() %>" == (form.email.value+form.email2.value)) {
						var email_chk = true;
					}
					else if("<%= arr.get(i).getId() %>" == (form.id.value)) {
						var id_chk = true;
					}
				<%}%>
...
<script>
	...
	<body>
		...
		<section id ="section_id">
			<form method = "post" action ="signup_result.jsp">
			<article>
				<div><img src ="image/welcome.png" /><h1><font>코베이옥션</font>에 오신 것을 환영합니다!</h1></div>
				<div>
					<table align="center">
						<tr>
						...
						<tr>
							<td colspan="3"><input type="text" class="filed2" name="id" maxlength="10" placeholder="4자리~10자리" onchange = "checkEnglish()"></td>
						</tr>
						<tr>
							<td colspan="3" class="signup_text"><font>비밀번호</font></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="3"><input type="text" class="filed2" name="name" maxlength="10" placeholder="최대10자리" onchange = "checkBrNan()"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text"  name="tel2" class="select_filed" onchange = "checkNumber()" size="13" maxlength="4" placeholder="4자리"></td>
							<td><input type="text"  name="tel3" class="select_filed"  onchange = "checkNumber()" size="13" maxlength="4" placeholder="4자리"></td>		
						</tr>
						<tr>
							<td colspan="3" class="signup_text"><font>이메일</font></td>
						</tr>
						<tr>
							<td colspan="2"><input type="text" name="email" class="select_filed" size="32" maxlength="15" placeholder="최대15자리" onchange = "checkEnglish()"></td>
							<td>
						...
						<tr>
							<td colspan="3"><input type="text" id="addr1" class="addr_text" name="addr1" maxlength="10" placeholder="주소">
							<input type="text" class="addr_text" id="addr2" name="addr2" maxlength="10" placeholder="참고항목"></td>
						</tr>
						<tr>
							<td colspan="3"><input type="text" id="addr3" class="filed_addr" name="addr3" maxlength="60" placeholder="상세주소"></td>
						</tr>
						...
						<tr>
							<td colspan="3"><p><input type="button" class="submit" value="가입하기" onclick="signup(this.form)"></p></td>
						</tr>
					</table>
				</div>
			</article>
