...
import vo.PageInfo;
 ...
 public class OnlineActionListToday implements Action {
	 ...
	 public ActionForward execute(HttpServletRequest request,HttpServletResponse response) throws Exception{
		...
		int listCount = onlineActionListService.getListCount_Today(); //총 리스트 수를 받아옴.
		articleList = onlineActionListService.getArticleList_Today(page,limit); //리스트를 받아옴.
		...
		request.setAttribute("articleMoneyList", articleNowMoneyList);		
   		forward.setPath("/MVC_online_action/MVC_online_action_Today.jsp");
   		return forward;
